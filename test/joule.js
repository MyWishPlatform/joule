...
contract('Joule', accounts => {
    ...
    it('#8 insert-insert-check-insert', async () => {
        ...
        await joule.register(address1, sevenMinutesInFuture, gasLimit1, gasPrice1, {
            from: RICH_MAN,
            value: gasLimit1 * gasPrice1
        });
        await joule.register(address2, threeMinutesInFuture, gasLimit2, gasPrice2, {
            from: RICH_MAN,
            value: gasLimit2 * gasPrice2
        });
        await joule.register(address3, threeMinutesInFuture, gasLimit2, gasPrice2, {
            from: RICH_MAN,
            value: gasLimit2 * gasPrice2
        });
        await joule.register(address2, fiveMinutesInFuture, gasLimit2, gasPrice2, {
            from: RICH_MAN,
            value: gasLimit2 * gasPrice2
        });
        await increaseTime(4 * MINUTE);
        await joule.check({from: RICH_MAN, gas: Number(2 * gasLimit2 + 100000)});
        await joule.register(address3, nineMinutesInFuture, gasLimit3, gasPrice3, {
            from: RICH_MAN,
            value: gasLimit3 * gasPrice3
        });
    ...
    it('#9 check chain of contracts same timestamps', async () => {
        ...
        await joule.register(address1, threeMinutesInFuture, gasLimit1, gasPrice1, {
            from: RICH_MAN,
            value: gasLimit1 * gasPrice1
        });
        await joule.register(address2, threeMinutesInFuture, gasLimit1, gasPrice1, {
            from: RICH_MAN,
            value: gasLimit1 * gasPrice1
        });
        await joule.register(address3, threeMinutesInFuture, gasLimit1, gasPrice1, {
            from: RICH_MAN,
            value: gasLimit1 * gasPrice1
        });
        await joule.register(address3, fiveMinutesInFuture, gasLimit3, gasPrice3, {
            from: RICH_MAN,
            value: gasLimit3 * gasPrice3
        });

        await increaseTime(4 * MINUTE);
        await joule.check({from: RICH_MAN, gas: Number(3 * gasLimit1 + 100000)});
        await joule.register(address1, fiveMinutesInFuture, gasLimit1, gasPrice1, {
            from: RICH_MAN,
            value: gasLimit1 * gasPrice1
        });
